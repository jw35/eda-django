    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service', models.CharField(blank=True, help_text='Short description of normal service ringing. No initial capital (unless day of week)', max_length=200, validators=[tower_database.models.Tower.time_validator])),
                ('practice', models.CharField(blank=True, help_text='Short description of normal practice ringing. No initial capital (unless day of week)', max_length=200, validators=[tower_database.models.Tower.time_validator])),
                ('practice_day', models.CharField(blank=True, choices=[('1', 'Monday'), ('2', 'Tuesday'), ('3', 'Wednesday'), ('4', 'Thursday'), ('5', 'Friday'), ('6', 'Saturday'), ('7', 'Sunday')], help_text='Day of the week of main practice', max_length=9)),
                ('practice_weeks', multiselectfield.db.fields.MultiSelectField(blank=True, choices=[('not', 'Not'), ('1st', '1st'), ('2nd', '2nd'), ('3rd', '3rd'), ('4th', '4th'), ('5th', '5th'), ('alternate', 'Alternate')], help_text='Week(s) of the month for main practice if not all', max_length=50, validators=[tower_database.models.Tower.week_validator])),
                ...
                ('latlng', models.CharField(blank=True, max_length=20, verbose_name='Location')),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'constraints': [models.UniqueConstraint(fields=('place', 'dedication'), name='unique_place_dedication', violation_error_message="Can't have two towers with the same place and dedication")],
            },
        ),
        migrations.CreateModel(
            name='Photo',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(height_field='height', upload_to=tower_database.models.rename_image, width_field='width')),
                ('height', models.SmallIntegerField(blank=True, editable=False, null=True)),
                ('width', models.SmallIntegerField(blank=True, editable=False, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigIntegerField(auto_created=True, blank=True, db_index=True, verbose_name='ID')),
                ('link_text', models.CharField(blank=True, help_text='Short link text for this website', max_length=50)),
                ('url', models.URLField()),
                ('history_id', models.AutoField(primary_key=True, serialize=False)),
                ('history_date', models.DateTimeField(db_index=True)),
                ('history_change_reason', models.CharField(max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigIntegerField(auto_created=True, blank=True, db_index=True, verbose_name='ID')),
                ('role', models.CharField(choices=[('C', 'General'), ('BL', 'Bells'), ('BA', 'Band'), ('TC', 'Tower Captain'), ('RM', 'Ringing Master'), ('SK', 'Steeplekeeper')], max_length=30)),
                ('publish', models.BooleanField(default=True)),
                ('primary', models.BooleanField(default=False, help_text='Primary com=ntact for this Tower?')),
                ('title', models.CharField(blank=True, choices=[('Mr', 'Mr.'), ('Mrs', 'Mrs.'), ('Miss', 'Miss.'), ('Dr', 'Dr.'), ('Revd', "The Rev'd")], help_text="Person's title (if required - usually leave blank)", max_length=5)),
                ('forename', models.CharField(blank=True, help_text="Person's forename", max_length=100)),
                ('name', models.CharField(blank=True, help_text="Person's surname, or office title", max_length=100)),
                ('phone1', models.CharField(blank=True, help_text='Personal/office contact phone number', max_length=100, verbose_name='phone')),
                ('phone2', models.CharField(blank=True, help_text='Alternate personal/office phone number', max_length=100, verbose_name='phone')),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'constraints': [models.UniqueConstraint(condition=models.Q(('primary', True)), fields=('tower',), name='unique_tower_primary', violation_error_message='Towers can only have a single primary contact')],
            },
        ),
        migrations.CreateModel(
            name='Website',
            ...
            options={
                'ordering': ['tower', 'url'],
                'constraints': [models.UniqueConstraint(fields=('tower', 'url'), name='unique_tower_url', violation_error_message="Can't have the same website more than once for the same tower")],
            },
        ),
    ]
